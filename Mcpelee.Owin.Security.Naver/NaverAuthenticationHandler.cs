...
{
    internal class NaverAuthenticationHandler : AuthenticationHandler<NaverAuthenticationOptions>
    {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new NaverAuthenticatedContext(Context, user, accessToken, expires);
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:naver:name", context.Name, XmlSchemaString, Options.AuthenticationType));

                    // Many Naver accounts do not set the UserName field.  Fall back to the Name field instead.
                    if (string.IsNullOrEmpty(context.UserName))
                    {
                ...
                {
                    context.Identity.AddClaim(new Claim("urn:naver:link", context.Link, XmlSchemaString, Options.AuthenticationType));
                }
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                var redirectContext = new NaverApplyRedirectContext(
                    Context, Options,
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            if (Options.CallbackPath.HasValue && Options.CallbackPath == Request.Path)
            {
                ...
                var context = new NaverReturnEndpointContext(Context, ticket);
