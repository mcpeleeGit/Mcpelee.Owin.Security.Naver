...
{
    /// <summary>
    /// OWIN middleware for authenticating users using Naver
    /// </summary>
    ...
    public class NaverAuthenticationMiddleware : AuthenticationMiddleware<NaverAuthenticationOptions>
    {
        ...
        public NaverAuthenticationMiddleware(
            OwinMiddleware next,
            IAppBuilder app,
            NaverAuthenticationOptions options)
            : base(next, options)
        {
            ...
            _logger = app.CreateLogger<NaverAuthenticationMiddleware>();
            ...
            if (Options.StateDataFormat == null)
            {
                IDataProtector dataProtector = app.CreateDataProtector(
                    typeof(NaverAuthenticationMiddleware).FullName,
        ...
        /// </summary>
        /// <returns>An <see cref="AuthenticationHandler"/> configured with the <see cref="NaverAuthenticationOptions"/> supplied to the constructor.</returns>
        protected override AuthenticationHandler<NaverAuthenticationOptions> CreateHandler()
        {
            return new NaverAuthenticationHandler(_httpClient, _logger);
        }

        [SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope", Justification = "Managed by caller")]
        private static HttpMessageHandler ResolveHttpMessageHandler(NaverAuthenticationOptions options)
        {
