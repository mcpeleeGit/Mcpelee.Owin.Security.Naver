...
{
    /// <summary>
    /// Context passed when a Challenge causes a redirect to authorize endpoint in the Naver middleware
    /// </summary>
    public class NaverApplyRedirectContext : BaseContext<NaverAuthenticationOptions>
    {
        ...
        /// <param name="options">The Naver middleware options</param>
        ...
        public NaverApplyRedirectContext(IOwinContext context, NaverAuthenticationOptions options,
